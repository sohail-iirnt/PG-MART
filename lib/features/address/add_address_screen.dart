...
class _AddAddressMapScreenState extends ConsumerState<AddAddressMapScreen> {
  ...
  final _manualAddressCtrl = TextEditingController(); // Lets them edit the auto-fetched address
  ...
  Future<void> _saveFinalAddress() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        // Combine manual inputs with the base address
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            if (_showDetailsForm) {
              setState(() => _showDetailsForm = false); // Go back to map view
            } else {
      ...
      body: _isLoading
        ...
        children: [
          ...
          GoogleMap(
            ...
            // Disable map interaction if the form is open
          ...
          // === THE FLOATING PIN (Hidden when typing details) ===
          if (!_showDetailsForm)
            Center(
              child: Padding(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(
              _isServiceable ? 'ENTER ADDRESS DETAILS' : 'NOT SERVICEABLE HERE',
